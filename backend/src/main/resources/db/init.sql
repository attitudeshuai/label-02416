...
-- Insert sample books
INSERT INTO `book` (`isbn`, `title`, `author`, `publisher`, `publish_date`, `category`, `price`, `stock`, `description`) VALUES
('978-7-111-42036-8', 'Java编程入门', '詹姆斯·高斯林', '机械工业出版社', '2020-01-15', '编程', 89.00, 10, 'Java编程语言的全面指南，适合初学者和进阶开发者'),
('978-7-111-42037-5', 'Spring Boot实战', '克雷格·沃尔斯', '人民邮电出版社', '2021-03-20', '编程', 79.00, 8, '从零开始学习Spring Boot框架开发'),
('978-7-111-42038-2', '数据库设计基础', '克里斯·戴特', '电子工业出版社', '2019-06-10', '数据库', 69.00, 15, '数据库设计的基础理论与实践'),
('978-7-111-42039-9', 'Python基础教程', '吉多·范罗苏姆', '机械工业出版社', '2022-02-28', '编程', 59.00, 12, 'Python编程语言入门教程'),
('978-7-111-42040-5', 'Web前端开发', '乔恩·达科特', '清华大学出版社', '2021-08-15', '前端', 99.00, 6, 'HTML、CSS和JavaScript核心技术详解'),
('978-7-111-42041-2', '算法导论', '托马斯·科尔曼', '机械工业出版社', '2020-06-01', '算法', 128.00, 5, '计算机算法的经典教材'),
('978-7-111-42042-9', '深入理解计算机系统', '兰德尔·布莱恩特', '机械工业出版社', '2019-12-15', '计算机', 139.00, 7, '从程序员视角深入理解计算机系统'),
('978-7-111-42043-6', 'Vue.js实战', '梁灏', '清华大学出版社', '2021-05-20', '前端', 79.00, 10, 'Vue.js框架从入门到精通');
